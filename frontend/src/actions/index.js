...
export const CATEGORIES_FETCH_SUCCESSFUL = 'CATEGORIES_FETCH_SUCCESSFUL';
export const POSTS_FETCH_SUCCESSFUL = 'POSTS_FETCH_SUCCESSFUL';
...
export default {
  ...
  fetchCategories: createAction(CATEGORIES_FETCH),
  fetchPosts: createAction(POSTS_FETCH),
